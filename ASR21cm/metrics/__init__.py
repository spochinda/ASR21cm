...
# scan all the files that end with '_metric.py' under the metrics folder
...
_metric_modules = [importlib.import_module(f'ASR21cm.metrics.{file_name}') for file_name in metric_filenames]
