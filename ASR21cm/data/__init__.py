# ALTERED COPY OF BASICSR /DATA/__INIT__.PY TO SUPPORT CUSTOM COLLATE_FN WITH BUILD_DATALOADER CHANGES
import importlib
import torch
...
_dataset_modules = [importlib.import_module(f'ASR21cm.data.{file_name}') for file_name in dataset_filenames]


def build_dataloader(dataset, dataset_opt, collate_fn=None, num_gpu=1, dist=False, sampler=None, seed=None):
    """Build dataloader.
